...
public class WeatherBot implements WeatherParser {
    ...
    private static String API_KEY_TEMPLATE = "&units=metric&cnt=8&APPID=af2ed85eb4017a81d8584d861a45f21a";
    ...
    public String getReadyForecast(String city, int days) {
        ...
        try {
            ...
            API_KEY_TEMPLATE = String.format("&units=metric&cnt=%s&APPID=af2ed85eb4017a81d8584d861a45f21a", 40);
            ...
            switch (days) {
                case 1:
                    for (final JsonNode objNode : arrNode) {
                        ...
                        if (forecastTime.contains(String.valueOf(LocalDateTime.now().getDayOfMonth()))) {
                ...
                case 3:
                    for (int i = 0; i < days; i++) {
                        ...
                        for (final JsonNode objNode : arrNode) {
                            String forecastTime = objNode.get("dt_txt").toString();
                            if (forecastTime.contains(String.valueOf(date))
                ...
                case 5:
                    for (int i = 0; i < days; i++) {
                        ...
                        for (final JsonNode objNode : arrNode) {
                            ...
                            Integer month = new Timestamp(format.parse(forecastTime).getTime()).toLocalDateTime().getDayOfMonth();
